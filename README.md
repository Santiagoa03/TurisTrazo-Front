...
1. Clonar el repositorio:
   ```bash
   git clone https://github.com/<tu-usuario>/turistrazo-frontend.git
   cd turistrazo-frontend
   
2. Instalar dependencias:npm install
   
3. Ejecutar el proyecto en modo desarrollo:  ng serve --proxy-config proxy.conf.json
...
- Sistema de rutas y componentes dinámicos
